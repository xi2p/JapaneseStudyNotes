...
\begin{tabularx}{\linewidth}{|M{0.3\linewidth}|X|X|X|}
    ...
    \multicolumn{4}{|c|}{} \\
    \hline
    \multirow{2}{*}{\parbox[c]{0.8\linewidth}{\centering （收获）外は $\to$ 内に}} & ～ていただく & 收到 & 高 \\
    \cline{2-4}
    & ～てもらう & 收到 & 中 \\
    \hline
    \multicolumn{4}{|c|}{} \\
    \hline
    \multirow{2}{*}{\parbox[c]{0.8\linewidth}{\centering （收获）内は $\to$ 外に}} & ～てくださる & 给我方 & 高 \\
    \cline{2-4}
    & ～てくれる & 给我方 & 中 \\
    \hline
\end{tabularx}
...
\begin{callout}
    ...
    \begin{itemize}
        \item 田中さんは　私に　本を\textbf{貸して}　もらいました。
    \end{itemize}

    \vspace{10pt}

    尽管主语是田中，但借书动作是\textbf{我发出的}，是我\textbf{借出}给田中，要用「貸す」。
\end{callout}
