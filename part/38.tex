...
\begin{tabularx}{\linewidth}{|M{0.3\linewidth}|X|X|X|}
    ...
    类别 & 表达 & 意思 & 敬意 \\
    \hline
    \multirow{3}{*}{\parbox[c]{0.8\linewidth}{\centering （给予）内は $\rightarrow $ 外に}} & ～てさしあげる & 给 & 高 \\
    \cline{2-4}
    & ～てあげる & 给 & 中 \\
    \cline{2-4}
    & ～てやる & 给（动物、植物） & 低 \\
    ...
    \multicolumn{4}{|c|}{} \\
    \hline
    \multirow{2}{*}{\parbox[c]{0.8\linewidth}{\centering （收获）内は $\leftarrow $ 外に}} & ～ていただく & 收到 & 高 \\
    \cline{2-4}
    & ～てもらう & 收到 & 中 \\
    \hline
    \multicolumn{4}{|c|}{} \\
    \hline
    \multirow{2}{*}{\parbox[c]{0.8\linewidth}{\centering （收获）外は $\rightarrow $ 内に}} & ～てくださる & 给我方 & 高 \\
    \cline{2-4}
    & ～てくれる & 给我方 & 中 \\
    \hline
\end{tabularx}
